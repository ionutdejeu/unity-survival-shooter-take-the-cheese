...
namespace Assets.Core.Input
{
	public class PlayerInputController : Singleton<InputController>
	{
		...
		public bool touchPressedThisFrame { get; protected set; }

		 
		public PointerInfo basicMouseInfo { get; protected set; }

		public MovemenAxisInfo basicAxisInfo { get; protected set; }
		...
		public event Action<MovemenAxisInfo> axisMoved;
